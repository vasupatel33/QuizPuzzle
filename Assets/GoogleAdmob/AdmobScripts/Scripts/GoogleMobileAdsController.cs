    ...
    public class GoogleMobileAdsController : Singleton<GoogleMobileAdsController>
    {
        ...
        private void Start()
        {
            ...
            MobileAds.Initialize((InitializationStatus initstatus) =>
            {
                ...
                _isInitialized = true;
                RewardAddController.LoadAd();
                InterstitialAddController.LoadAd();
            });
        }
        public void ShowRewardAdd()
        {
            RewardAddController.ShowAd();
            StartCoroutine(LoadRewardAdd());
        }
        IEnumerator LoadRewardAdd()
        {
        ...
        {
            InterstitialAddController.ShowAd();
            StartCoroutine(LoadInterstitialAdd());
        }
        IEnumerator LoadInterstitialAdd()
        {
            yield return new WaitForSeconds(3f);
            InterstitialAddController.LoadAd();
        }
        ...
        {
            bannerAddController.ShowAd();
            StartCoroutine (LoadBannerAdd());
        }
        IEnumerator LoadBannerAdd()
        {
            yield return new WaitForSeconds(3f);
            bannerAddController.LoadAd();
        }
        /// <summary>
